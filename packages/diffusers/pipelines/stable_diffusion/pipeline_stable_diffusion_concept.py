...
class StableDiffusionPipelineConcept(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromSingleFileMixin):
    r"""
    ...
    def __call__(
        ...
        print(prompt_embeds is not None ,'prompt_embeds')
