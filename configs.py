...
def parse_args(input_args=None):
    ...
    # ADDED
    parser.add_argument('--calibrate_neg',type=float,default=0)
    parser.add_argument('--calibrate_pos',type=float,default=0)
    ...
    parser.add_argument('--train_data_dir1',type=str)
    parser.add_argument('--train_data_dir2',type=str)
    parser.add_argument('--flip_p',type=float,default=0.5)
    parser.add_argument('--normalize_target1',type=float,default=0)
    parser.add_argument('--normalize_target2',type=float,default=0)
