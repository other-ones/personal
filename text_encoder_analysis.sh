...
accelerate launch --main_process_port 1234  text_encoder_analysis.py \
  ...
  --prior_concept1="cat" \
  --prior_concept2="dog" \
  --resume_unet_path='saved_models/dreambooth_models/multi/tmp_multi_learned_embeds_sim01_margin02/checkpoints/checkpoint-2000/unet_s2000.pt' \
  --resume_text_encoder_path='saved_models/dreambooth_models/multi/tmp_multi_learned_embeds_sim01_margin02/checkpoints/checkpoint-2000/text_encoder_s2000.pt' \
